...
\cite{theiler1992}. The task-shuffle null preserves the real count matrix
...
(\path{gate_b/run.py}, \path{04_p2/gate_b2/run4.py}, \path{gate_d/run.py},
\path{gate_d/run_mlp.py}, \path{gate_d/run_24seeds.py},
...
\item Gate D at $n=24$: \path{gate_d/run_24seeds.py} writes
\path{gate_d/results24/gate_d_summary.json} and
\path{gate_d24_seed_stats.json}; the $6$-seed artifacts are untouched.
