...
(Theiler et al., 1992). We also add a dead-drive
false-positive control and a fixed-weight readout-invariance test.
...
(\texttt{gate\_b/run.py}, \texttt{04\_p2/gate\_b2/run3.py}, \texttt{gate\_d/run.py},
\texttt{gate\_d/run\_mlp.py}, \texttt{gate\_d/run\_20seeds.py},
...
\item Gate D at $n=20$: \texttt{gate\_d/run\_20seeds.py} writes
\texttt{gate\_d/results20/gate\_d\_summary.json} and
\texttt{gate\_d20\_seed\_stats.json}; the $6$-seed artifacts are untouched.
