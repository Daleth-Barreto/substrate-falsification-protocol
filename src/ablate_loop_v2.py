...
def main():
    ...
    with open(RES / "f2_ablation_v2.json", "w") as fp:
        json.dump(out, fp, indent=2)

    fig = figure(results)
    fig.savefig(RES / "f2_ablation_v2.png", dpi=140)
    fig2 = latency_figure(results, intervals_all)
    fig2.savefig(RES / "f2_ablation_latency_v2.png", dpi=140)
    print("saved:", RES / "f2_ablation_v2.json", RES / "f2_ablation_v2.png",
          RES / "f2_ablation_latency_v2.png")
